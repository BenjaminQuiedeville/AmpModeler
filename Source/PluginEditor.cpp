...
IRLoaderPage::IRLoaderPage(Processor &audioProcessor) {
    ...
    ir1LoadButton.onClick = [&audioProcessor, this]() {
        juce::FileChooser chooser("Choose a .wav File to open", juce::File(), "*.wav");
        ...
        audioProcessor.irLoader.ir1.filesArray = parentFolder.findChildFiles(
    ...
    prevIR1Button.onClick = [&audioProcessor, this]() {
        ...
        if (audioProcessor.irLoader.ir1.fileIndex < 0) {
            audioProcessor.irLoader.ir1.fileIndex +=  audioProcessor.irLoader.ir1.filesArray.size();
        }
    ...
    bypassLoader2Toggle.onClick = [&audioProcessor, this]() {
